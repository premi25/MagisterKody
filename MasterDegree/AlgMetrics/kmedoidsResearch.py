...
kmedoidsWithScores(fileData100thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 5)
kmedoidsWithScores(fileData75thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 5)
kmedoidsWithScores(fileData50thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 4)
kmedoidsWithScores(fileData20thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 5)
kmedoidsWithScores(fileData10thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 4)