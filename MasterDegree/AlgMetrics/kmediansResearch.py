...
kmediansWithScores(fileData100thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 4)
kmediansWithScores(fileData75thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 5)
kmediansWithScores(fileData50thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 4)
kmediansWithScores(fileData20thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 5)
kmediansWithScores(fileData10thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 4)