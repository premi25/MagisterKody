...
def kmediansWithScores(filenameData, filenameSilhMean, filenameDBS, filenameCHS, kClusters):
...
kmediansWithScores(fileData100thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 223)
kmediansWithScores(fileData75thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 192)
kmediansWithScores(fileData50thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 154)
kmediansWithScores(fileData20thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 99)
kmediansWithScores(fileData10thousand, fileSilhMean, fileDBS, fileCHS, kClusters = 66)